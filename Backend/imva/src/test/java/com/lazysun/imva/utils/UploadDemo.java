...
public class UploadDemo {
    ...
    String ACCESS_KEY = "xbfmA9jghtmMZewOQ2nc_tpRl4_6fGtclpKuMarX";
    String SECRET_KEY = "Fy6GJAa9p3mMI9Dcl9Mi1SsuUYH6odNWPR1f5FS-";
    /**
     ...
     */
    String urlPrefix = "http://up-as0.qiniup.com"; // http://up-as0.qiniup.com";
    // 要上传的空间
    String bucketName = "notea-a";
    //上传到七牛后保存的文件名
    String key = "test.mp4";
    ...
    public void testUpload() {
        ...
        File f = new File("E:\\大三上\\七牛云1024\\data\\test-upload\\origin_file.mp4");
        long fileSize = f.length(); // 单位： B
